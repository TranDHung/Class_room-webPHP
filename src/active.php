...
<html lang="en">
  ...
  <body>
  <?php
		$mess = "Tính năng này dành cho giáo viên. Nếu bạn là giáo viên admin sẽ gửi email vào tài khoản bạn đang sử dụng.";
    ...
    <div class="row justify-content-center">
        <div class="col-md-6 col-lg-5">
            <form method="post" action="" class="border rounded w-100 mb-5 mx-auto px-3 pt-3 mt-5">
				...
				<div class="form-group">
                    <input name="check" id="check" type="checkbox"> Bạn là giáo viên
                </div>
                <div class="form-group">
                    <?php
						echo "$mess";
